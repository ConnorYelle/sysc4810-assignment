...
def test_rbac_client():
	...
	clientOperations = problem1c.get_permitted_operations(userClient)
	...
	try:
		...
		assert "view_financial_advisor_contact" in clientOperations
...
def test_rbac_premium_client():
	...
	premiumClientOperations = problem1c.get_permitted_operations(userPremiumClient)
	try:
		...
		assert "view_financial_advisor_contact" in premiumClientOperations
...
def test_rbac_financial_advisor():
	...
	financialAdvisorOperations = problem1c.get_permitted_operations(userFinancialAdvisor)
	try:
		...
		assert "view_financial_advisor_contact" not in financialAdvisorOperations
...
def test_rbac_financial_planner():
	...
	financialPlannerOperations = problem1c.get_permitted_operations(userFinancialPlanner)
	try:
		...
		assert "view_financial_advisor_contact" not in financialPlannerOperations
...
def test_rbac_teller():
	...
	tellerOperations = problem1c.get_permitted_operations(userTeller)
	try:
		...
		assert "view_financial_advisor_contact" not in tellerOperations
